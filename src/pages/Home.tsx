  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Floating Elements */}
        <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-primary rounded-full blur-3xl opacity-20 float" />
        <div className="absolute top-40 right-32 w-48 h-48 bg-gradient-secondary rounded-full blur-3xl opacity-20 float" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-32 left-1/4 w-24 h-24 bg-gradient-accent rounded-full blur-3xl opacity-20 float" style={{ animationDelay: '2s' }} />
